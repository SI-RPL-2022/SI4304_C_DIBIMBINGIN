...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid p-3">
            ...
            <form action="{{route('admin.editeventpost' , ['id'=>$data['id']])}}" method="post" enctype="multipart/form-data" class="">
                @csrf
                @method('post')
                <div class="form-group mb-3">
                    <input type="text" name="nama" placeholder="Nama Event" class="form-control"  value="{{$data['nama']}}" required>
                </div>

                <div class="form-group mb-3">
                    <input type="text" name="alamat" placeholder="Tempat Event" class="form-control"  value="{{$data['alamat']}}" required>
                </div>
