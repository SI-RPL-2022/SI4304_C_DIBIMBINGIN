...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid p-3">
            ...
            <form action="{{route('admin.addeventpost')}}" method="post" enctype="multipart/form-data" class="">
                @csrf
                @method('post')
                <div class="form-group mb-3">
                    <input type="text" name="nama" placeholder="Nama Event" class="form-control"  required>
                </div>

                <div class="form-group mb-3">
                    <input type="text" name="alamat" placeholder="Tempat Event" class="form-control"  required>
                </div>
                ...
                <div class="form-group mb-3">
                    <input type="date" name="tanggal" placeholder="Tanggal Event" class="form-control"  required>
                </div>

                <div class="form-group mb-3">
                    <h4 class="mt-4">Tentang Event</h4>
